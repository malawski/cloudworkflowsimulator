...
inter-related workflows grouped into {\em ensembles}.  Workflows in an
...
%% Ewa: maybe put url instead of citation
The
...
%The algorithmic complexity of SPSS is $O(n^2)$, where $n$ is the number of
%tasks in the ensemble. This derives from the fact that, for each task, 
...
%Ewa:  so it is really taking into account the workflow structure or the ensemble structure/members?
