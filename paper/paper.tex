...
workflow sizes in the ensemble (see Figure~\ref{fig:ensemble-pareto}). 
...
\begin{figure}[htb]
    \centering
    \subfloat[size]{
        \includegraphics[width=0.75\columnwidth]{size-selected-LIGO}
        }\\
    \subfloat[cost]{
        \includegraphics[width=0.75\columnwidth]{cost-selectedLIGO}
        }
...
\begin{figure*}[tb]
    \subfloat[Ratio of Actual Cost to Budget]{
        \includegraphics[width=0.45\textwidth]{run-finish-variations-test-0-output-cost-all}
        }
    \subfloat[Ratio of Actual Makespan to Deadline]{
        \includegraphics[width=0.45\textwidth]{run-finish-variations-test-0-output-makespan-all}
        }
...
\begin{figure*}[tb]
    \subfloat[Ratio of Actual Cost to Budget]{
        \includegraphics[width=0.45\textwidth]{run-finish-delays-test-0-output-cost-montage-uniform_unsorted}
        }
    \subfloat[Ratio of Actual Makespan to Deadline]{
        \includegraphics[width=0.45\textwidth]{run-finish-delays-test-0-output-dagfinish-montage-uniform_unsorted}
        }
