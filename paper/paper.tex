...
in resource management on grid and cloud infrastructures. What becomes more
important, workflows for large computational problems are often composed of
several inter-related workflows grouped into {\em ensembles}.  Workflows in an
...
create a hazard map.  In the recent study of 2013 CyberShake generates a map that
requires an ensemble of 286 workflows.  Similarly, users of
...
The granularity of the workflow tasks should be discussed in the context of the
length of the cloud billing cycle. In this paper we assumed that the resources
are charged for hourly time slots, as is the case of VM instances on Amazon EC2.
...
results for CyberShake and LIGO as representatives of fine grained and coarse
grained workflows. The figure shows that, for this experiment, the scores remain
...
with long delays, poor estimates, and high failure rates. This, however, comes
at the cost of being able to complete less workflows than SPSS. Alternatively, a
user may decide to accept that the budget and deadline constraints are exceeded,
as long as more work is completed.
