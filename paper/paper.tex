...
this paper, we address a new important problem of efficiently managing such
ensembles under both budget and deadline constraints on the
Infrastructure-as-a-Service (IaaS) clouds. The latter are characterized by
dynamic resource provisioning capabilities and a pay-per-use model.  We discuss,
...
budget and deadline parameters. This allows to identify the application
scenarios and constraint ranges for which the algorithms perform better. We
found that the key for algorithm performance is the decision which workflows
within an ensemble should be admitted or rejected for execution. The results
...
\begin{itemize}
  \item the definition of the scheduling problem of prioritized workflows grouped in
  ...
  \item the development of static and dynamic algorithms and of the simulator based
