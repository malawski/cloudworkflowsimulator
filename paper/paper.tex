...
study we assumed that the delays in VM start and terminate requests are negligible.
...
The goal of the workflow ensemble scheduling and cloud provisioning problem
considered in this paper is to complete as many high-priority workflows as
possible given a fixed budget and deadline. Only workflows for which all tasks
are finished by the deadline are considered to be complete---partial results are
not usable in this model.
...
\begin{figure}[htb] 
\centering
\includegraphics[width=1.0\columnwidth]{spds-gantt}
...
The static provisioning approach of SPDS may perform poorly when resource demand
...
cause the cost of the plan to exceed the budget. Once the plan is complete, 
...
in the workflow, the least expensive slot is chosen to schedule the 
...
\begin{figure}[tb] 
\centering
\includegraphics[width=1.0\columnwidth]{spss-gantt}
...
\begin{figure}[tb] 
\centering
\includegraphics[width=0.6\columnwidth]{ensemble-pareto}
