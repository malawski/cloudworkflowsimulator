...
\begin{figure}[tb] 
  \centering
  \includegraphics[width=\textwidth]{figures/spss-gantt}
...
\TODO{Edit this to remove duplication with section \ref{sec:ensembles}}
...
\begin{figure*}[t] 
\centering
\includegraphics[width=0.19\textwidth]{pareto-MONTAGE-n-1000-8-dagh1-20m0}
\includegraphics[width=0.19\textwidth]{pareto-CYBERSHAKE-n-1000-8-dagh1-20m0}
\includegraphics[width=0.19\textwidth]{pareto-LIGO-n-1000-8-dagh1-40m0}
\includegraphics[width=0.19\textwidth]{pareto-GENOME-n-1000-8-dagh100-1500m0}
\includegraphics[width=0.19\textwidth]{pareto-SIPHT-n-1000-8-dagh5-50m0}
...
ensemble. Similarly, when the number of workflows grows, and each 
...
in the workflow generator gallery~\cite{Bharathi2008}. The gallery contains synthetic
...
The constant distribution produces ensembles containing workflows with the same number of tasks per workflow, 
...
Figure~\ref{fig:ensemble-pareto}. The number of large workflows (of size $\geq$ 900) 
is slightly increased to represent the ``heavy-tail'', i.e. that there is a 
significant number of large workflows in the ensemble. We assume that large
...
\begin{figure*}[t]  
\centering
\includegraphics[width=0.19\textwidth]{pareto-size-MONTAGE-n-1000-8-dagh1-20m0}
\includegraphics[width=0.19\textwidth]{pareto-size-CYBERSHAKE-n-1000-8-dagh1-20m0}
\includegraphics[width=0.19\textwidth]{pareto-size-LIGO-n-1000-8-dagh1-40m0}
\includegraphics[width=0.19\textwidth]{pareto-size-GENOME-n-1000-8-dagh100-1500m0}
\includegraphics[width=0.19\textwidth]{pareto-size-SIPHT-n-1000-8-dagh5-50m0}
...
approximately \$12,000 and 1,500 hours to complete a full ensemble. These
...
%Figure~\ref{fig:score} shows the score $s$ as defined in Eq.~\ref{eq:score}
%computed for two sample applications. Comparing
%Figure~\ref{fig:number-complete-pareto} to Figure~\ref{fig:score} we can see that
...
% \includegraphics[width=0.19\textwidth]{score2-MONTAGE-n-1000-8-dagh1-20m0}
% \includegraphics[width=0.19\textwidth]{score2-CYBERSHAKE-n-1000-8-dagh1-20m0}
% \includegraphics[width=0.19\textwidth]{score2-LIGO-n-1000-8-dagh1-40m0}
% \includegraphics[width=0.19\textwidth]{score2-GENOME-n-1000-8-dagh100-1500m0}
% \includegraphics[width=0.19\textwidth]{score2-SIPHT-n-1000-8-dagh5-50m0}
...
\begin{figure}[htb] \centering
\includegraphics[width=0.7\columnwidth]{pareto-budget-SIPHT-n-1000-8-dagh5-50h4m0}\\
(a) ensemble of Pareto-distributed workflows
\includegraphics[width=0.7\columnwidth]{constant-budget-SIPHT-n-1000-0-dagh5-50h4m0}\\
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=0.75\textwidth]{distributions}
...
\begin{figure*}[p]
    \centering
    \subfloat[CyberShake]{
        \includegraphics[width=0.75\textwidth]{stretching_cybershake}
    }\\
    \subfloat[Montage]{
        \includegraphics[width=0.75\textwidth]{stretching_montage}
    }
...
\begin{figure*}[p]
    \subfloat[Ratio of Actual Cost to Budget]{
        \includegraphics[width=\textwidth]{variances_budget}
    }\\
    \subfloat[Ratio of Actual Makespan to Deadline]{
        \includegraphics[width=\textwidth]{variances_deadline}
    }
...
\begin{figure}[ht]
  ...
  \caption{Percentage of high scores achieved by each algorithm on Montage with uniform unsorted ensembles when runtime estimate error varies from $\pm$0\% to $\pm$50\%.}
  \label{fig:variances_scores}
\end{figure}

\begin{figure*}[p]
    \subfloat[Ratio of Actual Cost to Budget]{
        \includegraphics[width=\textwidth]{delays_budget}
    }\\
    \subfloat[Ratio of Actual Makespan to Deadline]{
        \includegraphics[width=\textwidth]{delays_deadline}
    }
