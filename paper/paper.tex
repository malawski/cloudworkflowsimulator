...
\newline
978-1-4673-0806-9/12/\$31.00 \copyright 2012 IEEE}}
\rfoot{}
\cfoot{}
...
\begin{figure}[tb] 
  \centering
  \subfloat[DPDS]{
  \includegraphics[width=0.40\textwidth]{figures/output-test-DPDS}
  \label{fig:algorithm-example-dpds}
  }\\
  \subfloat[SPSS]{
  \includegraphics[width=0.40\textwidth]{figures/output-test-SPSS}
