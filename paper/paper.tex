...
\begin{figure*}[tb]
    \subfloat[Ratio of Actual Cost to Budget]{
        \includegraphics[width=0.45\textwidth]{run-finish-failures-test-0-output-cost-all}
        }
    \subfloat[Ratio of Actual Makespan to Deadline]{
        \includegraphics[width=0.45\textwidth]{run-finish-failures-test-0-output-makespan-all}
        }
