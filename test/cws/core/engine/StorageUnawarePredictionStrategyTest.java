...
/**
 * Tests for {@link StorageUnawarePredictionStrategy} class.
 */
public class StorageUnawarePredictionStrategyTest {
    private StorageUnawarePredictionStrategy strategy;
    ...
    public void setUp() throws Exception {
        ...
        strategy = new StorageUnawarePredictionStrategy();
    }
    ...
    public void testGetPredictedRuntimeTask() {
        ...
        assertEquals(123, strategy.getPredictedRuntime(task, vmType, storageManager), 0.00001);
    }
}
