...
public class Transfer {
    ...
    public void updateProgress() {
        ...
        if (elapsed > 0) {
            ...
            long bitsTransferred = (long)Math.floor(
            ...
            if (this.bytesRemaining < 0) {
                throw new RuntimeException("Simulated transfer too long. " +
                        "Extra bytes transferred: "+Math.abs(this.bytesRemaining));
            }
        }
    }
    ...
    public double estimateTimeRemaining() {
        ...
        double timeRemaining = bytesRemaining*8.0 / 
                (this.currentBandwidth*MBPS_TO_BPS); 
