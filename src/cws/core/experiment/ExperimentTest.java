...
public class ExperimentTest {
    ...
    public void testRunExperimentMontage0() {
        ...
        for (double budget : budgets) {
            Experiment.generateConstantSeries(runDirectory, prefix, dagPath, dagName, budget, price, numDAGs, N, step,
                    start, max_scaling, taskDilatation, runtimeVariation, delay, alpha);
        }
    ...
    public void testRunSeriesRepeatPsmerge_small2_10() {
        ...
        for (double budget : budgets) {
            Experiment.generateSeriesRepeat(runDirectory, prefix, dagPath, dagName, budget, price, numDAGs, N, step,
                    start, max_scaling, alpha, taskDilatation, runtimeVariation, delay, 10);
        }
    }
}
