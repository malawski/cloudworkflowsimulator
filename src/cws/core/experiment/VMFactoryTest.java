...
public class VMFactoryTest {
	...
	public void testCreateVM() {
		...
		ContinuousDistribution provisioningDelayDistribution = new LognormalDistr(new java.util.Random(0),4.080645, 0.1655264);
		ContinuousDistribution deprovisioningDelayDistribution = new LognormalDistr(new java.util.Random(0), 2.96542, 0.09975135);
